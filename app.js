...
const message = messagesEl.querySelectorAll(".message");
const messageSearch = document.querySelector("#search-id");
...
// Remove active class from sizes
